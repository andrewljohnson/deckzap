...
from battle_wizard.views import create_card_cost
...
from battle_wizard.views import save_cost
from battle_wizard.views import save_deck
from battle_wizard.views import save_effects
from battle_wizard.views import save_name_and_image
...
urlpatterns = [
    ...
    path('create_card/save_cost', save_cost),    
    path('create_card/save_effects', save_effects),    
    path('create_card/save_name_and_image', save_name_and_image),    
    path('create_card/save_new', save_new_card),    
    path('create_card/<card_id>/cost', create_card_cost),
