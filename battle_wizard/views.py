...
from battle_wizard.game.cards.cards_and_effects import Effects
from battle_wizard.game.cards.cards_and_effects import effect_types
from battle_wizard.game.cards.cards_and_effects import target_types
...
def create_card_effects(request, card_id):
    """
...
def create_card_name_and_image(request, card_id):
    """
